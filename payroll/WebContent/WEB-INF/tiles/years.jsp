...
<table id="myTable" class="table table-striped table-hover">
	...
	<c:forEach var="year" items="${years}">
		<tr>
			<td><c:out value="${year.year}"></c:out></td>

			<td><a
				href="${pageContext.request.contextPath}/deleteYear/${year.yearId}"><span
					onclick="return confirm('Are you sure to delete this?')" class="glyphicon glyphicon-remove"></span></a><a
				href="${pageContext.request.contextPath}/updateYear/${year.yearId}"><span
