...
<br />
	<sf:form action="${pageContext.request.contextPath}/result"
			method="get" commandName="employeesalary" cssStyle="form-horizontal">
...
<div class="form-group">
	...
	<a href="<c:url value="/pagat" />" class="btn btn-default">Cancel</a>
</sf:form>
