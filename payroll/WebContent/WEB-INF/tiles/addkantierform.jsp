...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
            ...
            <h1>Add Knatier</h1>
		<spring:url value="/addkantier" var="saveK"/>
        <sf:form action="${saveK}"
                   method="POST" modelAttribute="kantier" >
            <sf:hidden path="kantierId" />       
            
            <div class="form-group">
			<label for="kantierName" style="vertical-align: top;text-align: right;">Kantieri:</label>
