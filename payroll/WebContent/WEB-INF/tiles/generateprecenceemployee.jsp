...
<h3>Gjenero ne Excel Listprecencen per Punetore:</h3>
<br />
	<sf:form action="${pageContext.request.contextPath}/excelemployeePresenceReport"
			method="get" commandName="pagat" cssStyle="form-horizontal">
