...
<sf:form action="${pageContext.request.contextPath}/editUser/${user.id}"
	method="POST"  modelAttribute="user" >
	  <sf:input type="hidden" name="id" path="id" value="${user.id}"/>     
	...
	<div class="form-group">
		<label for="authority">Role</label> <label class="checkbox-inline"><sf:radiobutton
			...
			class="checkbox-inline"><sf:radiobutton path="authority"
				id="authority" value="ROLE_ADMIN" style="margin-left: 14px"
